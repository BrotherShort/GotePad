...
func _id_pressed(id: int) -> void:
	match id:
		0: # 撤销 Undo
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_UNDO)
		1: # 重做 Redo
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_REDO)
		3: # 剪切 Cut
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_CUT)
		4: # 复制 Copy
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_COPY)
		5: # 粘贴 Paste
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_PASTE)
		7: # 全选 Select All
			_gote_edit.text_edit.menu_option(TextEdit.MenuItems.MENU_SELECT_ALL)
		9: # 查找 Find
